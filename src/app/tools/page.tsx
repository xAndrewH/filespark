...
const CATEGORIES = [
  {
    ...
    tools: [
      ...
      { href: "/tools/case-converter",  icon: "Aa", title: "Case Converter",          description: "Convert text between camelCase, snake_case, kebab-case, CONSTANT_CASE, and more." },
      { href: "/tools/grammar-checker", icon: "✏️", title: "Grammar & Spell Checker", description: "Check grammar, spelling, and style issues powered by LanguageTool." },
      { href: "/tools/code-beautifier", icon: "✨", title: "Code Beautifier",          description: "Format and prettify HTML, JavaScript, and Python code with one click." },
    ],
  },
  {
    id: "design-visual",
  ...
  },
  {
    ...
    tools: [
      ...
      { href: "/tools/calculator",        icon: "🧮", title: "Calculator",              description: "Basic and advanced scientific calculator with history. Toggle between modes." },
      { href: "/tools/currency-converter",icon: "💱", title: "Currency Converter",      description: "Live exchange rates for 160+ currencies. Swap, compare, and convert instantly." },
      { href: "/tools/time-calculator",   icon: "⏱",  title: "Time Calculator",         description: "Calculate time between two times, add/subtract durations, and combine intervals." },
    ],
  },
  {
    id: "reference",
    ...
    tools: [
      ...
      { href: "/tools/framework-reference",icon: "📚", title: "Framework Reference",     description: "Searchable code snippets for Tailwind, Bootstrap, Sass, React, and Next.js." },
    ],
  },
  {
    id: "images-pdfs",
