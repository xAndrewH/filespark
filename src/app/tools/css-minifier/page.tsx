  ...
  return (
    <div className="min-h-screen bg-slate-950">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <h1 className="text-3xl font-bold text-white mb-1">CSS Minifier</h1>
        <p className="text-slate-500 text-sm mb-8">Strip comments, whitespace, and redundant characters from CSS to reduce file size.</p>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Input */}
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <label className="text-xs font-medium text-slate-400 uppercase tracking-wide">Input CSS</label>
