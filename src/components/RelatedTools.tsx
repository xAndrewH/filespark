...
const TOOL_INFO: Record<string, { title: string; description: string }> = {
  ...
  "/tools/grammar-checker":     { title: "Grammar & Spell Checker",   description: "Check grammar, spelling, and style powered by LanguageTool." },
  ...
  "/tools/background-remover":  { title: "Background Remover",        description: "AI-powered background removal in your browser." },
  ...
  "/tools/pdf-to-images":       { title: "PDF to Images",             description: "Convert each PDF page to a PNG at multiple quality levels." },
...
const RELATED: Record<string, string[]> = {
  ...
  "/tools/image-editor":        ["/tools/image-compressor", "/tools/background-remover", "/tools/favicon"],
  "/tools/image-compressor":    ["/tools/image-editor", "/tools/background-remover", "/tools/svg-to-png"],
  ...
  "/tools/svg-to-png":          ["/tools/favicon", "/tools/raster-to-svg", "/tools/image-editor"],
  "/tools/raster-to-svg":       ["/tools/svg-to-png", "/tools/image-editor", "/tools/background-remover"],
  "/tools/pdf-merge":           ["/tools/pdf-to-images", "/tools/image-compressor", "/tools/image-editor"],
  "/tools/pdf-to-images":       ["/tools/pdf-merge", "/tools/image-editor", "/tools/image-compressor"],
