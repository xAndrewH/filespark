      ...
      >
        ...
        <div className="text-center">
          <p className="text-white font-semibold text-lg mb-1.5">
            {isDragging ? "Release to upload" : "Drop any file to convert it"}
          </p>
          <p className="text-slate-500 text-sm">
            {isDragging ? "We'll take it from here" : "Images, video, audio, PDF, documents, fonts, archives"}
          </p>
        </div>
        ...
        <p className="text-slate-600 text-xs px-4 text-center">
